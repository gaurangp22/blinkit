...
const Address = () => {
  ...
  return (
    <div className=''>
        ...
        <div className='bg-slate-50 p-2 grid gap-4'>
              {
              ...
              <div onClick={()=>setOpenAddress(true)} className='h-16 bg-slate-50 border-2 border-dashed flex justify-center items-center cursor-pointer'>
                Add address
              </div>
        </div>
