            ...
            <form className='grid gap-4' onSubmit={handleSubmit}>
              ...
              <div className='grid gap-1'>
                ...
                <textarea
                  ...
                  multiple
                  rows={3}
                  className='bg-slate-50 p-2 outline-none border focus-within:border-primary-200 rounded resize-none'
                />
              </div>
              <div>
                <p className='font-medium'>Image</p>
                <div>
                  <label htmlFor='productImage' className='bg-slate-50 h-24 border rounded flex justify-center items-center cursor-pointer'>
